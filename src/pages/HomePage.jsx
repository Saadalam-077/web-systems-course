  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900/30 to-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Telegram Banner */}
        <a href="https://t.me/+zM3ofe7r9P9mMDk0" target="_blank" rel="noopener noreferrer" className="block mb-8 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-2xl p-4 hover:from-blue-500 hover:to-cyan-400 transition-all">
        ...
        <div className="mt-12 bg-slate-800/50 rounded-2xl p-8 border border-slate-700 text-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 mt-6">
            <a href="https://t.me/+zM3ofe7r9P9mMDk0" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-6 py-4 bg-blue-600 hover:bg-blue-500 rounded-xl">
