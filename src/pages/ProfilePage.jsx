      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-8 bg-slate-800/50 rounded-2xl p-6 border border-slate-700">
          ...
          <div className="grid grid-cols-5 gap-2 text-center text-sm">
            ...
            <div className="bg-blue-900/30 rounded-lg p-2"><span className="text-blue-400 font-bold">B+</span><p className="text-slate-400">80-84%</p></div>
            <div className="bg-blue-900/20 rounded-lg p-2"><span className="text-blue-300 font-bold">B</span><p className="text-slate-400">75-79%</p></div>
